...
RUN apk add -q --progress --no-cache --update openvpn wget ca-certificates iptables unbound unzip tinyproxy jq && \
    ...
    wget -q https://github.com/qdm12/files/raw/master/named.root.updated -O /etc/unbound/root.hints && \
    wget -q https://github.com/qdm12/files/raw/master/root.key.updated -O /etc/unbound/root.key && \
    cd /tmp && \
    wget -q https://github.com/qdm12/files/raw/master/malicious-hostnames.updated -O malicious-hostnames && \
    wget -q https://github.com/qdm12/files/raw/master/nsa-hostnames.updated -O nsa-hostnames && \
    wget -q https://github.com/qdm12/files/raw/master/malicious-ips.updated -O malicious-ips && \
